...
if(!( function_exists('ebor_register_nav_menus') )){
	function ebor_register_nav_menus() {
		register_nav_menus( 
			array(
				'primary'  => esc_html__( 'Standard Navigation', 'pillar' ),
				'offscreen'  => esc_html__( 'Offscreen & Slide Navigation', 'pillar' ),
				'left-vertical'  => esc_html__( 'Left Vertical Navigation', 'pillar' ),
				'footer'  => esc_html__( 'Footer Navigation', 'pillar' )
			) 
		);
	}
...
if(!( function_exists('ebor_register_sidebars') )){
	function ebor_register_sidebars() {
		...
		register_sidebar( 
			array(
				'id' => 'primary',
				'name' => esc_html__( 'Blog Sidebar', 'pillar' ),
				'description' => esc_html__( 'Widgets to be displayed in the blog sidebar.', 'pillar' ),
		...
		register_sidebar( 
			array(
				'id' => 'shop',
				'name' => esc_html__( 'Shop Sidebar', 'pillar' ),
				'description' => esc_html__( 'Widgets to be displayed in the shop sidebar.', 'pillar' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s sidebar__widget">',
				'after_widget' => '</div>',
				'before_title' => '<h6>',
				'after_title' => '</h6><hr>'
		...
		register_sidebar(
			array(
				'id' => 'footer1',
				'name' => esc_html__( 'Footer Column 1', 'pillar' ),
				'description' => esc_html__( 'If this is set, your footer will be 1 column', 'pillar' ),
		...
		register_sidebar(
			array(
				'id' => 'footer2',
				'name' => esc_html__( 'Footer Column 2', 'pillar' ),
				'description' => esc_html__( 'If this & column 1 are set, your footer will be 2 columns.', 'pillar' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s sidebar__element">',
				'after_widget' => '</div>',
				'before_title' => '<h6 class="widget-title">',
				'after_title' => '</h6>'
		...
		register_sidebar(
			array(
				'id' => 'footer3',
				'name' => esc_html__( 'Footer Column 3', 'pillar' ),
				'description' => esc_html__( 'If this & column 1 & column 2 are set, your footer will be 3 columns.', 'pillar' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s sidebar__element">',
				'after_widget' => '</div>',
				'before_title' => '<h6 class="widget-title">',
				'after_title' => '</h6>'
		...
		register_sidebar(
			array(
				'id' => 'footer4',
				'name' => esc_html__( 'Footer Column 4', 'pillar' ),
				'description' => esc_html__( 'If this & column 1 & column 2 & column 3 are set, your footer will be 4 columns.', 'pillar' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s sidebar__element">',
				'after_widget' => '</div>',
				'before_title' => '<h6 class="widget-title">',
				'after_title' => '</h6>'
