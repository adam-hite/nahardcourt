...
if(!( function_exists('ebor_vc_add_att') )){
	function ebor_vc_add_attr(){
		...
		vc_add_param('pillar_team', $attributes);
		...
		vc_add_param('pillar_testimonial', $attributes);
		...
		vc_add_param('pillar_client', $attributes);
		...
		vc_add_param('pillar_portfolio', $attributes);
		...
		vc_add_param('pillar_blog', $attributes);
...
if(!( function_exists('ebor_vc_page_template') )){
	function ebor_vc_page_template( $template ){
		...
		if( 'no' == get_option('pillar_vc_redirect_' . $post->post_type) )
			return $template;
